        ...
        <div className="space-y-8">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                By accessing and using Xi Combinator's platform and services, you accept and agree to be bound by 
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Xi Combinator provides an accelerator platform that offers:
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Participation in Xi Combinator programs is subject to an application and selection process:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>Applications must be complete and accurate</li>
                <li>Selection decisions are at Xi Combinator's sole discretion</li>
                <li>No guarantee of acceptance into any program</li>
                <li>Application materials become property of Xi Combinator</li>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  Xi Combinator and protected by copyright and trademark laws.
                </p>
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-muted-foreground">Participation in Xi Combinator programs involves:</p>
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Xi Combinator provides services "as is" without warranties. We are not liable for any 
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2 text-muted-foreground">
                ...
                <p><strong>Email:</strong> legal@xicombinator.com</p>
                <p><strong>Address:</strong> Xi Combinator, 123 Innovation Street, Bangalore, Karnataka 560001</p>
